...
.stat-card.lc h3 { color: #52aaff }
.stat-card.fnb h3 { color: #38d996 }
.stat-card.karaoke h3 { color: #f5a14a }
...
.id { font-weight: 700; }
.badge { background: rgba(201,162,77,.15); color: var(--gold); border: 1px solid rgba(201,162,77,.35); border-radius: 999px; padding: 3px 10px; font-size: 12px; }
.price { font-weight: 700; }
.row-hover:hover { background: rgba(201,162,77,.06); }
