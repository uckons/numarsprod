  ...
  >
    ...
    <div class="actions">
      ...
      <button
        ...
        class="stop"
        :disabled="!timer.id"
        @click="timer.id && $emit('stop', timer.id)"
      >
        Stop
      </button>
...
const emit = defineEmits(["start", "stop", "extended"])
...
const onExtend = async () => {
  const res = await Swal.fire({
    title: "Extend Timer?",
    text: "Durasi service akan ditambah dan order akan bertambah",
    icon: "warning",
